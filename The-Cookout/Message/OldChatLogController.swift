...
class ChatLogController: DatasourceController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, MessageCellDelegate {
    ...
    fileprivate func handleVideoSelectedForUrl(_ url: URL) {
        ...
        let uploadTask = storageRef.putFile(from: url, metadata: nil, completion: { (_, error) in
    ...
    fileprivate func uploadToFirebaseStorageUsingImage(_ image: UIImage, completion: @escaping (_ imageUrl: String) -> Void) {
