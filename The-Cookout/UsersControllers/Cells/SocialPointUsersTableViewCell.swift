//
//  SocialPointUsersTableViewCell.swift
//  The-Cookout
//
...
class SocialPointUsersTableViewCell: UITableViewCell {
    ...
    func configureCell(for user: User) {
        ...
        if let statusString = user.onlineStatus as? String {
            if statusString == statusOnline {
                subtitle.textColor = SocialPointPalette.defaultBlue
        ...
        let urlString = user.thumbnailPhotoURL
