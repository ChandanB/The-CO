...
enum ViewPlaceholderTitle: String {
  case denied = "SocialPoint doesn't have access to your contacts"
  case empty = "You don't have any SocialPoint Friends yet."
  case emptyChat = "You don't have any active conversations yet."
}

enum ViewPlaceholderSubtitle: String {
  case denied = "You need friends!"
  case empty = "You can invite your friends to SocialPoint if you have an invite code."
