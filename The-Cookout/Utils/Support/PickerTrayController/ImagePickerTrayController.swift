...
public let ImagePickerTrayWillShow: Notification.Name = Notification.Name(rawValue: "ch.chandanbrown.ImagePickerTrayWillShow")
public let ImagePickerTrayDidShow: Notification.Name = Notification.Name(rawValue: "ch.chandanbrown.ImagePickerTrayDidShow")

public let ImagePickerTrayWillHide: Notification.Name = Notification.Name(rawValue: "ch.chandanbrown.ImagePickerTrayWillHide")
public let ImagePickerTrayDidHide: Notification.Name = Notification.Name(rawValue: "ch.chandanbrown.ImagePickerTrayDidHide")
...
public class ImagePickerTrayController: UIViewController {
  ...
  var newSelectedIndexPaths = [IndexPath]()
    ...
    fileprivate func requestImage(for asset: PHAsset, completion: @escaping (_ image: UIImage?) -> Void) {
