...
let cameraAccessDeniedMessage = "SocialPoint needs access to your camera to take photos and videos.\n\nPlease go to Settings –– Privacy –– Camera –– and set SocialPoint to ON."
let contactsAccessDeniedMessage = "SocialPoint needs access to your contacts to create new ones.\n\nPlease go to Settings –– Privacy –– Contacts –– and set SocialPoint to ON."
let microphoneAccessDeniedMessage = "SocialPoint needs access to your microphone to record audio messages.\n\nPlease go to Settings –– Privacy –– Microphone –– and set SocialPoint to ON."
let photoLibraryAccessDeniedMessage = "SocialPoint needs access to your photo library to send photos and videos.\n\nPlease go to Settings –– Privacy –– Photos –– and set SocialPoint to ON."

let cameraAccessDeniedMessageProfilePicture = "SocialPoint needs access to your camera to take photo for your profile.\n\nPlease go to Settings –– Privacy –– Camera –– and set SocialPoint to ON."
let photoLibraryAccessDeniedMessageProfilePicture = "SocialPoint needs access to your photo library to select photo for your profile.\n\nPlease go to Settings –– Privacy –– Photos –– and set SocialPoint to ON."

let videoRecordedButLibraryUnavailableError = "To send a recorded video, it has to be saved to your photo library first. Please go to Settings –– Privacy –– Photos –– and set SocialPoint to ON."
